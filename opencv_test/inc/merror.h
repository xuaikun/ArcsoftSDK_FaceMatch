...
#define MERR_ASF_READ_PHONE_STATE_DENIED				(MERR_ASF_BASE+16)				//android.permission.READ_PHONE_STATE权限被拒绝
#define	MERR_ASF_ACTIVATION_DATA_DESTROYED				(MERR_ASF_BASE+17)				//激活数据被破坏,请删除激活文件，重新进行激活
#define	MERR_ASF_SERVER_UNKNOWN_ERROR					(MERR_ASF_BASE+18)				//服务端未知错误
